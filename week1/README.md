...
## Failid
### individual/
- `week1_roll_a_sales_explorer.sql` — kõik SQL päringud koos kommentaaridega (11 päringut)
- `week1results_screenshot.png` — tulemuste ekraanitõmmis Supabase'ist

### team/
- `week1_data_landscape.md` — meeskonna koondülevaade kõigist tabelitest (Rollid A–D)
